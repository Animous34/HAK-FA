...
\033[3;97m❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖
\033[1;93m➾ DEVOLPER : COMMANDER X
\033[1;92m➾ COMMAND TYPE : WITHOUT LOGIN
\033[1;96m➾ TELEGRAM : https://t.me/Yassin_Tools
...
\033[1;93m➾ DEVOLPER : COMMANDER X 
\033[1;92m➾ COMMAND TYPE : WITHOUT LOGIN
\033[1;96m➾ WHATAAP : https://t.me/Yassin_Tools
\033[1;92m➾ NOTE : USE 4G FAST INTERNET
\033[1;95m➾ NOTE : NO NEED PROXY/VPN 
\033[1;97m❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖                  
"""                         
...
def login():
    ...
    time.sleep(0.05)
    jalan("\033[1;92m⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠛⠋⠉⠀⠀⠀⠀⠉⠉⠛⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿ ")
    jalan("\033[1;92m⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠟⠉\033[1;93m⠀ YASSINHAKER⠀\033[1;92m⠈⠻⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿ ")
    jalan("\033[1;92m⣿⣿⣿⣿⣿⣿⣿⣿⣿⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿ ")
    jalan("\033[1;92m⣿⣿⣿⣿⣿⣿⣿⣿⠃⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣠⣆⠀⠀⠀⠈⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿ ") 
    jalan("\033[1;92m⣿⣿⣿⣿⣿⣿⣿⡿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣸⣿⣿⡏⠀⠀⠀⠀⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿ ")
    jalan("\033[1;92m⣿⣿⣿⣿⣿⣿⣿⡇⠀⠀⠀⠀⠀⣠⣤⣤⣤⣴⣶⣾⣿⣿⣿⠀⠀⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿ ")
    ...
    jalan("\033[1;92m⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⣿⣿⣶⣶⣶⣶⣶⣶⣿⣷⣶⣦⣤⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿ ")
    jalan("\033[1;92m⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿ ")                                                                                            
    print "\033[1;95m«------------------\033[1;96mYASSIN HAKER\033[1;95m----------------»"
    print "\033[1;97m◈◈◈◈[1]◈◈◈◈\x1b[3;92mALGERIE CLONE\n"
    time.sleep(0.05)
    print "\033[1;97m◈◈◈◈[2]◈◈◈◈\x1b[3;93mEGYPTE CLONE\n"
    time.sleep(0.05)
    print "\033[1;97m◈◈◈◈[3]◈◈◈◈\x1b[3;95mIRAQ CLONE\n"
    time.sleep(0.05)
    print "\033[1;97m◈◈◈◈[4]◈◈◈◈\x1b[3;94mYASSIN YOUTUBE CHANNEL\n"
    time.sleep(0.05)
    print "\033[1;97m◈◈◈◈[5]◈◈◈◈\x1b[3;96mYASSIN TELEGRAM GROUP\n"
    time.sleep(0.05)
...
def pilih_crack():
    ...
    if Somi =="":
        ...
        jalan('\033[1;92m█▀█ █░▄ █░▀▌ █▀▀ █▐█▀ █ █▀▀
        jalan('\033[1;96m▀░▀ ▀▀▀ ▀▀▀░ ▀▀▀ ▀░▀▀ ▀ ▀▀▀
        print "\033[1;92mENTER ANY ALGERIE  NUMBER"+'\n \x1b[1;95m'
        ...
        jalan('\033[1;92m█▀▀ █░▀▌ ░░█░░ █░█ ░█░ █▀▀')
        jalan('\033[1;96m ▀▀▀ ▀▀▀░ ░░▀░░ █▀░ ░▀░ ▀▀▀')        
        print "\033[1;93mENTER ANY EGYPTE NUMBER"+'\n \x1b[1;95m'
        ...
        jalan('\033[1;96m╔║║╗║╗╣║╠╣║╚╗║')
        jalan('\033[1;94m╚══╝╚╩╝╚╝╚╝─╚╝')      
        print "\033[1;96mENTER ANY IRAQ  NUMBER"+'\n \x1b[1;95m'
    	...
    	os.system('xdg-open https://t.me/Yassin_Tools')
    else:
